                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="tab-general">
                                ...
                                <div class="form-group required">
                                    <label class="col-lg-2 col-md-2 col-sm-2 col-xs-12 control-label"><span data-toggle="tooltip" title="<?php echo $help_author; ?>"><?php echo $entry_author; ?></label>
                                ...
                                <div class="form-group required">
                                    <label class="col-lg-2 col-md-2 col-sm-2 col-xs-12 control-label">
                                        <!--
                                        <span data-toggle="tooltip" title="<?php echo $help_article; ?>">
                                            -->
                                        <?php echo $entry_article; ?>
                                    </label>
                                    <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
