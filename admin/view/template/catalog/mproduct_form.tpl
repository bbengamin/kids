            ...
            <div class="tab-pane active" id="tab-general">
              ...
              <div class="tab-content">
                  ...
                  <div class="form-group">
                      <label class="col-sm-4 control-label" for="input-mainsize">
                          <strong style="color:red">NEW! </strong>
                            <span data-toggle="tooltip" title="You can enter only!!! such types: big, small or default">
                                Type of Product page according to main image size
                            </span>
                      </label>
                      <div class="col-sm-8">
                          <input type="text" name="mainsize" value="<?php echo $mainsize; ?>" placeholder="Image wrapper size" id="input-mainsize" class="form-control" />
                      </div>
                  </div>
...
<!--new options for product-->
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <textarea class="summernote" name="product_description[<?php echo $language['language_id']; ?>][html_product_tab]" placeholder="<?php echo $entry_html_product_tab; ?>" id="input-html_product_tab<?php echo $language['language_id']; ?>"><?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['html_product_tab'] : ''; ?></textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <textarea class="summernote" name="product_description[<?php echo $language['language_id']; ?>][short_description]" placeholder="<?php echo $entry_short_description; ?>" id="input-short_description<?php echo $language['language_id']; ?>"><?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['short_description'] : ''; ?></textarea>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-8">
                      <textarea class="summernote" name="product_description[<?php echo $language['language_id']; ?>][description]" placeholder="<?php echo $entry_description; ?>" id="input-description<?php echo $language['language_id']; ?>"><?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['description'] : ''; ?></textarea>
                    </div>
                  </div>
                  <div class="form-group required">
