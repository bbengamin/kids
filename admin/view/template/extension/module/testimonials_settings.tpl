      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-html" class="form-horizontal">
          <div class="form-group required">
            ...
            <div class="col-sm-10">
              <input type="text" name="testimonials_path" value="<?php echo $testimonials_path; ?>" placeholder="<?php echo $entry_path; ?>" id="input-path" class="form-control" />
              <?php if ($error_path) { ?>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <select name="testimonials_show_path" id="input-show-path" class="form-control">
              	<?php if ($testimonials_show_path) { ?>
		  ...
		  <?php foreach ($languages as $language) { ?>		
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input type="text" name="testimonials_path_title[<?php echo $language['language_id']; ?>][path_title]" value="<?php echo isset($testimonials_path_title[$language['language_id']]['path_title']) ? $testimonials_path_title[$language['language_id']]['path_title'] : ''; ?>" placeholder="<?php echo $entry_path_title; ?>" id="input-path<?php echo $language['language_id']; ?>" class="form-control" />
          ...
          <?php } ?>
            ...
            <div class="col-sm-10">
              <select name="testimonials_num_columns" id="input-num-columns" class="form-control">
                <?php if ($testimonials_num_columns == 1) { ?>
                <option value="1" selected="selected">1</option>
                <option value="2">2</option>
                <option value="3">3</option>
                <?php } elseif ($testimonials_num_columns == 2) { ?>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <select name="testimonials_show_image" id="input-show-image" class="form-control">
              	<?php if ($testimonials_show_image) { ?>
                	<option value="1" selected="selected"><?php echo $text_yes; ?></option>
                	<option value="0"><?php echo $text_no; ?></option>
               	<?php } else { ?>
                	<option value="1"><?php echo $text_yes; ?></option>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" name="testimonials_width" value="<?php echo $testimonials_width; ?>" placeholder="<?php echo $entry_width; ?>" id="input-width" class="form-control" />
              <?php if ($error_width) { ?>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" name="testimonials_height" value="<?php echo $testimonials_height; ?>" placeholder="<?php echo $entry_height; ?>" id="input-height" class="form-control" />
              <?php if ($error_height) { ?>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <select name="testimonials_seo" id="input-status" class="form-control">
                <?php if ($testimonials_seo) { ?>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <select name="testimonials_status" id="input-status" class="form-control">
                <?php if ($testimonials_status) { ?>
                <option value="1" selected="selected"><?php echo $text_enabled; ?></option>
                <option value="0"><?php echo $text_disabled; ?></option>
                <?php } else { ?>
                <option value="1"><?php echo $text_enabled; ?></option>
