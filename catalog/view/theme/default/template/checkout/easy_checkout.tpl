        ...
        <div class="col-md-12 col-lg-4 register_block">
			<div>
                ...
                <div class="divider--xl"></div>
				 ...
				 <label class="radio" for="payment_address">
				  <input type="radio" name="payment_address" id="payment_address" value="existing" checked="checked" onclick="jQuery('#payment-address-new').hide()" />
				  <span class="outer">
                    <span class="inner"></span>
                </span>
			    ...
			    <?php if (isset($customer_id)) { ?>
				  ...
				  <label class="radio" for="payment_address_new">
				  <input type="radio" name="payment_address" id="payment_address_new" value="new" onclick="jQuery('#payment-address-new').show();"/>
				  				  <span class="outer">
                    <span class="inner"></span>
                </span>
