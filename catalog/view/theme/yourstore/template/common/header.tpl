...
<script type="text/javascript" src="catalog/view/theme/<?php echo $theme; ?>/js/home_js_compress.php"></script>
    ...
    $j(document).ready(function() {
        ...
        if ($j("#off-canvas-menu").length > 0) {
            ...
            $j(".off-canvas-menu-toggle").colorbox({
                ...
                colorBoxCartPos: 0,
                close:'<?php echo (isset($customisation_translation[$langs]["menu_close"][$store_id]) ? $customisation_translation[$langs]["menu_close"][$store_id] : "close"); ?>'
            })
