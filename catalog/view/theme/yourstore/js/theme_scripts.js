        ...
        $.ajax({
            ...
            success: function(json) {
                ...
                if (json['success']) {
                    ...
                    setTimeout(function () {
                        $j('#cart > button').html('<span class="icon icon-shopping_basket"></span><span id="cart-total" class="badge badge--cart"> ' + str1 + '</span><span class="cart-text name-text">My Cart</span>');
                    }, 1000);
