<?php
class ControllerCommonRightHome extends Controller {
	public function index() {
		...
		$modules = $this->model_design_layout->getLayoutModules($layout_id, 'right_home');
        ...
        return $this->load->view('common/right_home', $data);
	}
}
