<?php
class ControllerCommonRightHome2 extends Controller {
	public function index() {
		...
		$modules = $this->model_design_layout->getLayoutModules($layout_id, 'right_home2');
        ...
        return $this->load->view('common/right_home2', $data);
	}
}
