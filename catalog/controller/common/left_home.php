<?php
class ControllerCommonLeftHome extends Controller {
	public function index() {
		...
		$modules = $this->model_design_layout->getLayoutModules($layout_id, 'left_home');
        ...
        return $this->load->view('common/left_home', $data);
	}
}
