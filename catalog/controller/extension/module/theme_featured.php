				...
				if ($product_info) {
                    ...
                    if ($results_images) {
                        foreach ($results_images as $results_image) {
                            $data['additional_images1'][] = array(
                                'image' => $this->model_tool_image->resize($results_image['image'], $setting['width'], $setting['height']),
                                'image2x' => $this->model_tool_image->resize($results_image['image'], $setting['width']*2, $setting['height']*2)
                            );
                        }
                    } else {
